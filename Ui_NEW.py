...
leftPage = PageButtons(main)
leftPage.grid(row=1, column=1, sticky='nsew')
leftPage.grid_columnconfigure(1,weight=1)
leftPage.grid_rowconfigure(0, weight=1)
rightPage = AccountInfo(main)
rightPage.grid_columnconfigure(1,weight=1)
rightPage.grid_rowconfigure(0, weight=1)
rightPage.grid(row=1, column=2, sticky='nsew')
main.mainloop()